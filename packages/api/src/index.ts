...
app.register(async (app) => {
  ...
  app.put('/bots/:id/knowledge-bases/:kbId', { preHandler: [app.authenticate] }, async (request, reply) => {
  ...
  app.delete('/bots/:id/knowledge-bases/:kbId', { preHandler: [app.authenticate] }, async (request, reply) => {
    const { kbId } = request.params as { kbId: string };
    const user = request.user!;
