...
export const paypalWebhookRoutes: FastifyPluginAsync = async (app) => {
  app.post('/paypal', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
...
async function handleSubscriptionCreated(app: any, resource: any) {
...
async function handleSubscriptionActivated(app: any, resource: any) {
  const subscriptionId = resource.id;
  const status = resource.status;
...
async function handleSubscriptionUpdated(app: any, resource: any) {
  const subscriptionId = resource.id;
  const status = resource.status;
...
async function handleSubscriptionCancelled(app: any, resource: any) {
  const subscriptionId = resource.id;
...
async function handleSubscriptionSuspended(app: any, resource: any) {
  const subscriptionId = resource.id;
...
async function handleSubscriptionExpired(app: any, resource: any) {
  const subscriptionId = resource.id;
...
async function handlePaymentFailed(app: any, resource: any) {
  const subscriptionId = resource.id;
...
async function handleSubscriptionReactivated(app: any, resource: any) {
  const subscriptionId = resource.id;
