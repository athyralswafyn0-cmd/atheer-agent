...
export class KnowledgeProcessor {
    ...
    async processKnowledgeBase(job) {
    ...
    async extractSitemapContent(sitemapUrl) {
        try {
    ...
    async chunkAndStore(kb, content) {
...
// Worker setup
export const createKnowledgeWorker = (prisma, openai, _queue) => {
